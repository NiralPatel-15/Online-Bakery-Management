...
if (isset($_POST['login'])) {
  ...
  if ($ret > 0) {
    ...
    $msg = "Invalid Details."; // Set message for popup
  }
}
?>
<!DOCTYPE html>
        ...
        <div class="col-lg-7">
          ...
          <form method="post" action="">
            <div class="form-group col-md-12">
              <input type="text" class="form-control" name="emailcont" placeholder="Registered Email or Contact Number" required>
            </div>
            ...
            <div class="form-group col-md-12">
              <button type="submit" name="login" class="btn order_s_btn form-control">Login</button>
            </div>
            <div class="form-group col-md-12">
