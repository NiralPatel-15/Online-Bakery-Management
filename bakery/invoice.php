...
<?php  
$oid=$_GET['oid'];
$query=mysqli_query($con,"select tblorderaddresses.OrderTime,tblproduct.Image,tblproduct.ItemName,tblproduct.Weight,tblproduct.ItemPrice,tblorders.FoodId,tblorders.OrderNumber from tblorders 
