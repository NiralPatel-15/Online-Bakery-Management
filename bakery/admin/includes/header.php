 ...
 */
 ...
 <div class="row border-bottom">
     <nav class="navbar navbar-static-top white-bg" role="navigation" style="margin-bottom: 0">
         ...
         <p style="font-size: 20px;padding-top:1%;color: indianred;"><strong> Bakery House...!!</strong></p>
                         ...
                         <a href="mailbox.html" class="dropdown-item">
                             <div>
                                 ...
                                 <?php if ($num > 0) {
                                    ...
                                    ?>
                                         <a class="dropdown-item" href="vieworder.php?orderid=<?php echo $result['Ordernumber']; ?>"> <i class="fa fa-envelope fa-fw"></i> #<?php echo $result['Ordernumber']; ?> Order Received from <?php echo $result['FirstName']; ?></a>
                                     <?php }
                                    } else { ?>
