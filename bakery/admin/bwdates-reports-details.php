...
<head>
    ...
    <title> Bakery House ||Between Dates Report Details</title>
...
$cnt=$cnt+1;
                         ...
                         <?php if($rtype=="Order being Prepared"){?>
              ...
              <?php
$ret=mysqli_query($con,"select * from tblorderaddresses where OrderFinalStatus='Order being Prepared' && OrderTime between '$fdate' and '$tdate'");
$cnt=1;
while ($row=mysqli_fetch_array($ret)) {
...
$cnt=$cnt+1;
            ...
            <h4 align="center" style="color:blue">Report from <?php echo $fdate?> to <?php echo $tdate?> of Order Pickup</h4>                         
              ...
              <?php
$ret=mysqli_query($con,"select * from tblorderaddresses where OrderFinalStatus='Order Pickup' && OrderTime between '$fdate' and '$tdate'");
$cnt=1;
while ($row=mysqli_fetch_array($ret)) {
...
$cnt=$cnt+1;
            ...
            <h4 align="center" style="color:blue">Report from <?php echo $fdate?> to <?php echo $tdate?> of delivered Orders</h4>                         
              ...
              <?php
$ret=mysqli_query($con,"select * from tblorderaddresses where OrderFinalStatus='Order Delivered' && OrderTime between '$fdate' and '$tdate'");
$cnt=1;
while ($row=mysqli_fetch_array($ret)) {
