...
$query=mysqli_query($con,"delete from tblproduct where ID='$catid'");
    if ($query) {
     ...
     echo "<script>window.location.href='manage-item.php'</script>";
  } else {
              ...
              <tbody>
                <tr>
                  ...
                  <td><a href="edit-product.php?editid=<?php echo $row['ID'];?>">Edit</a>  | 
                    <a href="manage-item.php?delfood=<?php echo $row['ID'];?>" style="color:red;" onclick="return confirm('Do you really want to delete the item?');">Delete</a>
                </tr>
                <?php 
$cnt=$cnt+1;
}?>
