...
<head>
    ...
    <title> Bakery House|| Between Dates Report</title>
...
<form name="bwdatesreport"  action="bwdates-reports-details.php" method="post"> 
                ...
                <input type="radio" name="requesttype" value="">Not Confirmed Order
                  ...
                  <input type="radio" name="requesttype" value="Order Confirmed">Confirmed Order
                    <input type="radio" name="requesttype" value="Order being Prepared">Order Being Prepared Order
                      <input type="radio" name="requesttype" value="Order Pickup">Order Pickup Order
                      <input type="radio" name="requesttype" value="Order Delivered">Order Delivered order
                                        </div>
                                    </div>
