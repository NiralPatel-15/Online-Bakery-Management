...
if($row['OrderFinalStatus']=="Order being Prepared")
{
...
<?php
  ...
  if($orserstatus=="Order Confirmed" || $orserstatus=="Order being Prepared" || $orserstatus=="Order Pickup" || $orserstatus=="" ){ ?>
...
<?php  if($orserstatus!=""){
$ret=mysqli_query($con,"select tblordertracking.OrderCanclledByUser,tblordertracking.remark,tblordertracking.status as fstatus,tblordertracking.StatusDate from tblordertracking where tblordertracking.OrderId ='$oid'");
$cnt=1;
