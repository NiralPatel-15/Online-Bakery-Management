...
<head>
    <title> Bakery House || Dashboard</title>
...
?>
      <a class="text-muted text-uppercase m-b-20" href="confirmed-order.php" style="font-size: 20px"><strong>Confirmed Order</strong></a>                          
         ...
         <div class="col-lg-4">
                        <div class="ibox ">
                            <div class="ibox-title">
                                <?php $query3=mysqli_query($con,"Select * from  tblorderaddresses where OrderFinalStatus ='Order being Prepared'");
$beigpre=mysqli_num_rows($query3);
?>
<a class="text-muted text-uppercase m-b-20" href="orderbeingprepared.php" style="font-size: 20px"><strong>Order being Prepared</strong></a>
                               
                              
                            </div>
                            <div class="ibox-content">
                                <h1 class="no-margins"><?php echo $beigpre;?></h1>
                                <small>Order being Prepared</small>
                            </div>
                        </div>
            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="ibox ">
                            <div class="ibox-title">
                                <?php $query4=mysqli_query($con,"Select * from tblorderaddresses where OrderFinalStatus ='Order Pickup'");
$foodpickup=mysqli_num_rows($query4);
?>
<a class="text-muted text-uppercase m-b-20" href="order-pickup.php" style="font-size: 20px"><strong> Order Pickup</strong></a>
                    ...
                    <div class="col-lg-4">
                        <div class="ibox ">
                            <div class="ibox-title">
                                <?php $query5=mysqli_query($con,"Select * from  tblorderaddresses where OrderFinalStatus ='Order Delivered'");
$fooddel=mysqli_num_rows($query5);
?>
<a class="text-muted text-uppercase m-b-20" href="order-delivered.php" style="font-size: 20px"><strong>Total Order Deliver</strong></a>

                            </div>
                            <div class="ibox-content">
                                <h1 class="no-margins"><?php echo $fooddel;?></h1>
                                <small>Total Order Deliver</small>
                            </div>
                        </div>
                    </div>
