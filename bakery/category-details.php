    ...
    <section class="our_cakes_area p_100">
        <div class="container">
            <div class="main_title">
                <h2>Our Categories wise Items</h2>
                <h5>From soft, fluffy cakes to crispy cookies, buttery croissants, fresh-baked breads, and indulgent pastries—every bite is a taste of pure delight!</h5>
            </div>
